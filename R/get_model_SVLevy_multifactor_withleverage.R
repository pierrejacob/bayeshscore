...
get_model_SVLevy_multifactor_withleverage <- function(timesteps,
  ...
  model$rinitial = function(theta,Nx){
    ...
    # lambda2 = theta[6]
    # w = theta[7]
    return (rinitial_SVLevy_multifactorleverage_cpp(Nx,timesteps[1],theta[3],theta[4],theta[5],theta[6],theta[7]))
  }
  ...
  model$rtransition = function(Xs,t,theta){
    ...
    # lambda2 = theta[6]
    # w = theta[7]
    return (rtransition_SVLevy_multifactorleverage_cpp(Xs, timesteps[t-1], timesteps[t],
                                                       theta[3], theta[4],
