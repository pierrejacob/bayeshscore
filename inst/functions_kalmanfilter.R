...
kalmanfilter = function(Y,lineargaussianmodel) {
  ...
  muX_t_t_1 = vector("numeric",T) #contains the means of X_t given Y_1,...,Y_t-1
  muX_t_t = vector("numeric",T) #contains the means of X_t given Y_1,...,Y_t
  PX_t_t_1 = vector("numeric",T) #contains the variances of X_t given Y_1,...,Y_t-1
  PX_t_t = vector("numeric",T) #contains the variances of X_t given Y_1,...,Y_t
  muY_t_t_1 = vector("numeric",T) #contains the means of Y_t given Y_1,...,Y_t-1
  PY_t_t_1 = vector("numeric",T) #contains the variances of Y_t given Y_1,...,Y_t-1
