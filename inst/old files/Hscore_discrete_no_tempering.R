...
hscore_discrete_no_tempering <- function(observations, model, algorithmic_parameters){
  ...
  Hscore[1] = Hd(1,model,observations[,1],thetas,thetanormw,Xpred,XprednormW,Ntheta)
  ...
  for (t in 2:nobservations){
    ...
    Hscore[t] = Hscore[t-1] + Hd(t,model,observations[,t],thetas,thetanormw,Xpred,XprednormW,Ntheta)
