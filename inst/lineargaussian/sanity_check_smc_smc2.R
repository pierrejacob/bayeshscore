...
ggplot() +
  geom_line(aes(1:time_t,smc_results$logevidence[1:time_t]), color = "black", size = 1) +
  geom_line(aes(1:time_t,smc2_results$logevidence[1:time_t]), color = "purple", size = 1) +
  geom_line(aes(1:time_t,smc2_results_temp$logevidence[1:time_t]), color = "blue", size = 1)

# Check the h-score
ggplot() +
  geom_line(aes(1:time_t,smc2_results$hscore[1:time_t]), color = "purple", size = 1) +
  geom_line(aes(1:time_t,smc2_results_temp$Hscore[1:time_t]), color = "blue", size = 1)
