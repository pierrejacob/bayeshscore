...
for (t in 1:nobservations){
  ...
  # plot(ggplot(data.frame(theta = smc_result$thetas_history[[t+1]][1,],
  #                   weight = smc_result$normw_history[[t+1]])) +
...
ggplot() +
  geom_line(aes(1:nobservations, smc_result$logevidence),size = 1) +
